...
# resource "null_resource" "vault_path_deletion" {
#   triggers = {
#     destroy_resource = "${module.virtual-machine.resource_destroyed}"
#   }

#   provisioner "local-exec" {
#     command = <<-EOT
#       vault delete "secret/sshkeys/${var.environment}/${var.vmname}" 
#     EOT
#     interpreter = ["bash", "-c"]
#   }
